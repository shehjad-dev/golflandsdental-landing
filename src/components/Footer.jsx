...
const Footer = () => {
    return (
        <section className="bg-[#033B62] text-white">
            <div className="flex sm:flex-row flex-col gap-2 items-center justify-center mx-auto  py-20 border-b-2 border-white">
                <div className="w-[200px] flex flex-col items-center justify-center sm:mb-0 mb-4">
                    <a href="tel:080046533368" className="cursor-pointer">
                ...
                <div className="w-[200px] flex flex-col items-center justify-center sm:mb-0 mb-4">
                    <a
                        href="https://www.facebook.com/golflandsdental"
                        target="_blank"
                        className="cursor-pointer"
                    >
